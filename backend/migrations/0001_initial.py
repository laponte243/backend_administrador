# Generated by Django 3.2.7 on 2022-01-26 19:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_MovimientoInventario', models.IntegerField(help_text='Numero de MovimientoInventario del producto', null=True)),
                ('cantida_disponible', models.FloatField(help_text='Cantidad disponible del producto')),
                ('instancia', models.ForeignKey(help_text='Instancia asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.instancia')),
                ('producto', models.ForeignKey(help_text='Producto base del MovimientoInventario', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.producto')),
            ],
        ),
        migrations.AddField(
            model_name='menu',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('instancia', models.ForeignKey(blank=True, db_constraint=False, help_text='Instancia asociada', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.instancia')),
                ('producto', models.ForeignKey(blank=True, db_constraint=False, help_text='Producto base del MovimientoInventario', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.producto')),
            ],
            options={
