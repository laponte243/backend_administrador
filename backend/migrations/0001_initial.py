# Generated by Django 3.2.7 on 2022-03-07 20:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('inventario_fijo', models.TextField(help_text='MovimientoInventario fijo asociado del producto asociado', max_length=150, null=True)),
                ('fecha_vencimiento', models.TextField(help_text='Fecha de vencimiento del MovimientoInventario', max_length=150, null=True)),
                ('producto_fijo', models.TextField(help_text='producto asociado', max_length=150)),
                ('lote', models.TextField(help_text='lote del producto', max_length=150, null=True)),
                ('cantidada', models.FloatField(default=0, help_text='Cantidad vendida')),
                ...
                ('total_producto', models.TextField(default=0, help_text='subtotal del producto', max_length=150)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
