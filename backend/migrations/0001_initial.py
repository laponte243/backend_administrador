# Generated by Django 3.2.7 on 2022-05-03 14:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comprobante', models.TextField(default=0, help_text='comprobante del pago')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('F', 'Factura'), ('N', 'Nota entrega'), ('C', 'Nota credito'), ('D', 'Nota debito'), ('P', 'Proforma'), ('E', 'Pedido')], default='P', help_text='tipo de numero', max_length=1)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
