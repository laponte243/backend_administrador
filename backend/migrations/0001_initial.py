# Generated by Django 3.2.7 on 2022-02-25 14:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('porcentaje', models.FloatField(help_text='Porcentaje de la lista de precio')),
                ('instancia', models.ForeignKey(help_text='Instancia asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.instancia')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unidad', models.ForeignKey(blank=True, db_constraint=False, default=None, help_text='Unidad de medida del producto', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.unidad')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical lista precio',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('MovimientoInventario_producto', models.ForeignKey(blank=True, db_constraint=False, help_text='MovimientoInventario del producto asociado', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.movimientoinventario')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('instancia', models.ForeignKey(blank=True, db_constraint=False, help_text='Instancia asociada', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.instancia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lista_precio', models.ForeignKey(blank=True, db_constraint=False, help_text='Lista de precio asociada', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.listaprecio')),
                ('pedido', models.ForeignKey(blank=True, db_constraint=False, help_text='Pedido asociado', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.pedido')),
                ('producto', models.ForeignKey(blank=True, db_constraint=False, help_text='Producto asociado', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.producto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('MovimientoInventario_producto', models.TextField(help_text='MovimientoInventario fijo asociado del producto asociado', max_length=150, null=True)),
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('MovimientoInventario', models.ForeignKey(blank=True, db_constraint=False, help_text='MovimientoInventario asociado del producto', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.movimientoinventario')),
                ('factura', models.ForeignKey(blank=True, db_constraint=False, help_text='venta asociada', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.factura')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('instancia', models.ForeignKey(blank=True, db_constraint=False, help_text='Instancia asociada', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='backend.instancia')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', models.TextField(default=0, help_text='Precio por la cantidad del producto')),
                ('inventario', models.TextField(default=True, help_text='La venta afecta el inventario?')),
                ('MovimientoInventario_producto', models.ForeignKey(help_text='MovimientoInventario del producto asociado', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.movimientoinventario')),
                ('instancia', models.ForeignKey(help_text='Instancia asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.instancia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lista_precio', models.ForeignKey(help_text='Lista de precio asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.listaprecio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio', models.TextField(default=0, help_text='precio del producto o servicio a vender', max_length=150)),
                ('subtotal', models.TextField(default=0, help_text='subtotal del producto', max_length=150)),
                ('MovimientoInventario', models.ForeignKey(help_text='MovimientoInventario asociado del producto', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.movimientoinventario')),
                ('factura', models.ForeignKey(help_text='venta asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.factura')),
                ('instancia', models.ForeignKey(help_text='Instancia asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.instancia')),
            ],
        ),
