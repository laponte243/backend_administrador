    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numerologia', models.TextField(blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='Instancia',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio_seleccionadoo', models.TextField()),
                ('numerologia', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.TextField(blank=True, help_text='Nombre del producto', max_length=150)),
                ...
                ('precio_4', models.FloatField(default=0, help_text='Precio del producto 3', null=True)),
                ...
                ('instancia', models.ForeignKey(help_text='Instancia asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.instancia')),
                ('marca', models.ForeignKey(help_text='Marca asociada al producto', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.marca')),
            ],
        ),
        migrations.CreateModel(
            name='Vendedor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numerologia', models.TextField(blank=True)),
                ('fecha_despacho', models.DateTimeField(blank=True, default=None, null=True)),
                ('cliente', models.ForeignKey(help_text='cliente asociado', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.cliente')),
                ('empresa', models.ForeignKey(help_text='empresa asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.empresa')),
                ('instancia', models.ForeignKey(help_text='Instancia asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.instancia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instancia', models.ForeignKey(help_text='Instancia asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.instancia')),
                ('menuinstancia', models.ForeignKey(help_text='Opcion de menu asociada', on_delete=django.db.models.deletion.CASCADE, to='backend.menuinstancia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comprobante', models.TextField(default=0, help_text='Comprobante de la nota de pago')),
                ('fecha_comprobante', models.DateTimeField(help_text='Fecha del comprobante')),
                ('descripcion', models.TextField(blank=True, help_text='Pequeña descripcion', max_length=150, null=True)),
                ('numerologia', models.TextField(blank=True)),
                ('fecha', models.DateTimeField(auto_now_add=True)),
                ('cliente', models.ForeignKey(help_text='cliente asociado', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.cliente')),
                ('instancia', models.ForeignKey(help_text='Instancia asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.instancia')),
                ('vendedor', models.ForeignKey(help_text='Vendedor asociado', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.vendedor')),
            ],
        ),
        migrations.CreateModel(
            name='NotaFactura',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('A', 'Nota devolucion'), ('B', 'Nota Control'), ('C', 'Nota credito'), ('D', 'Nota debito'), ('E', 'Proforma'), ('F', 'Factura'), ('N', 'Nota entrega'), ('P', 'Pedido')], default='P', help_text='tipo de numero', max_length=1)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_producto', models.FloatField(default=0, help_text='total por producto')),
                ('instancia', models.ForeignKey(help_text='Instancia asociada', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.instancia')),
                ('inventario', models.ForeignKey(help_text='Inventario asociado', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='backend.inventario')),
